 ...
 */
final class Version20220110124513 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajout relation prestataire user';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE prestataire ADD user_id INT DEFAULT NULL');
